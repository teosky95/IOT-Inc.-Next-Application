...
<input type="submit" value="INSERISCI PROPIETA" name="inserisci_museo" class="bottone"/>
<input type="submit" value="MODIFICA PROPIETA" name="modifica_museo" class="bottone"/>
<input type="submit" value="ELIMINA PROPIETA" name="elimina_museo" class="bottone"/>
